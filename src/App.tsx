...
function App() {
  ...
  const [selectedVersion, setSelectedVersion] = useState<string>('1.0.12');
  ...
  const versionOptions = ['(todas)', '1.0.3', '1.0.4', '1.0.5', '1.0.6', '1.0.7', '1.0.8','1.0.9', '1.0.10','1.0.11','1.0.12'];
